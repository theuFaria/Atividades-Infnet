...
public class HttpRequestHelper {
    ...
    public ApiResponse requestById(int id) throws IOException {
        String ID = Integer.toString(id);
        return request("/" + ID, "GET");
    }

    public ApiResponse post(String caminho, String method, String payload ,String contentType) throws IOException {
        ...
        if(method.equalsIgnoreCase("POST") || method.equalsIgnoreCase("PUT")) {
            ...
            //Coloca post como o padrão do método.
